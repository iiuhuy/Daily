...
- Linux 基础的相关操作。熟悉服务器，nginx、docker 的部署。
- 重装自己的 Ubuntu 系统，打算换成 18.04。
- 前端 [CSS 日常练习](https://alvinmi.github.io/CSS-Track)、JS 重新看一遍「高程」、「你不知道的 JS 系列」。
- 前端框架学习，「重学前端专栏」。
- 还有时间再看看 ROS 相关的东西。
- 学习完并且有产出，在线笔记、博客、公众号都好。
